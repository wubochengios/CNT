...
#pragma mark - security
    ...
    self.securityView.layer.cornerRadius = 5 * IPHONE6_WIDTH;
    ...
    self.securityTextField.placeholder = @"Pass word";
    ...
    self.textGetCodeBtn.layer.cornerRadius = 5 * IPHONE6_WIDTH;
...
#pragma mark - 确认密码
    self.confirmPasswordView = [[UIView alloc] initWithFrame:CGRectMake(39 * IPHONE6_WIDTH, 385 * IPHONE6_HEIGHT, 297 * IPHONE6_WIDTH, 50 * IPHONE6_HEIGHT)];
    self.confirmPasswordView.backgroundColor = [UIColor colorWithRed:255.0f/255.9f green:91.0f/255 blue:95.0f/255 alpha:0.46];
    self.confirmPasswordView.layer.cornerRadius = 5 * IPHONE6_WIDTH;
    self.confirmPasswordView.clipsToBounds = YES;
    [self addSubview:self.confirmPasswordView];
    //密码图标
    self.confirmPasswordImage = [UIImage imageNamed:@"icon_yaoshi_pressed"];
    self.confirmPasswordImageView = [[UIImageView alloc] initWithImage:self.confirmPasswordImage];
    self.confirmPasswordImageView.frame = CGRectMake(17 * IPHONE6_WIDTH, 13 * IPHONE6_HEIGHT, 20 * IPHONE6_WIDTH, 20 * IPHONE6_HEIGHT);
    [self.confirmPasswordView addSubview:self.confirmPasswordImageView];
    //密码输入textfield
    self.confirmPasswordTextField = [[UITextField alloc] initWithFrame:CGRectMake(57 * IPHONE6_WIDTH, 17 * IPHONE6_HEIGHT, 220 * IPHONE6_WIDTH, 15 * IPHONE6_HEIGHT)];
    self.confirmPasswordTextField.clearButtonMode = UITextFieldViewModeWhileEditing;//编辑出x
    self.confirmPasswordTextField.placeholder = @"Please enter your password";
    self.confirmPasswordTextField.textColor = [UIColor whiteColor];
...
#pragma mark - Next
    ...
    self.deterMineBtn.frame = CGRectMake(39 * IPHONE6_WIDTH, 513 * IPHONE6_HEIGHT, 297 * IPHONE6_WIDTH, 50 * IPHONE6_HEIGHT);
    self.deterMineBtn.backgroundColor = [UIColor colorWithRed:255.0f/255.9f green:91.0f/255 blue:95.0f/255 alpha:1];
    [self.deterMineBtn setTitle:@"Next" forState:UIControlStateNormal];
    self.deterMineBtn.layer.cornerRadius = 5 * IPHONE6_WIDTH;
...
#pragma mark - 返回键子
    ...
    self.backBtn.titleLabel.font = [UIFont systemFontOfSize:13 * IPHONE6_HEIGHT];
    [self.backBtn setTitle:@"Return" forState:UIControlStateNormal];
    [self.backBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    self.backBtn.layer.cornerRadius = 8 * IPHONE6_WIDTH;
