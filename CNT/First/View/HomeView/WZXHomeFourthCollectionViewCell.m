//
//  WZXHomeFourthCollectionViewCell.m
//  CNT
//
...
@implementation WZXHomeFourthCollectionViewCell
...
- (void)createSubView {
#pragma mark - 大图
    self.bigImage = [UIImage imageNamed:@"content_icon_tupian_09_pressed"];
    self.bigImageView = [[UIImageView alloc] initWithImage:self.bigImage];
    self.bigImageView.frame = CGRectMake(15 * AUTO_WIDTH, 10 * AUTO_HEIGHT, 125 * AUTO_WIDTH, 85 * AUTO_HEIGHT);
    [self addSubview:self.bigImageView];
    //题目
    self.titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(160 * AUTO_WIDTH, 12 * AUTO_HEIGHT, 125 * AUTO_WIDTH, 20 * AUTO_HEIGHT)];
    self.titleLabel.text = @"Introduction to Chinese";
    self.titleLabel.font = [UIFont systemFontOfSize:14 * AUTO_WIDTH];
    ...
    self.lessonHourLabel.font = [UIFont systemFontOfSize:18 * AUTO_HEIGHT];
    ...
    self.lessonMoneyLabel.text = @"¥7699";
