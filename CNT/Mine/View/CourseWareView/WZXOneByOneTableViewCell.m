...
@implementation WZXOneByOneTableViewCell
...
- (void)createSubView {
    ...
    self.bigImage = [UIImage imageNamed:@"content_icon_tupian_05_pressed"];
    ...
    self.classLabel.text = @"老子快难受死了，还特么敲代码";
